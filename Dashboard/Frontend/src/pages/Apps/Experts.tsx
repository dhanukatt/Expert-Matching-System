        ...
        try {
            if (params._id) {
                ...
                const response = await axios
                    .put(`http://localhost:8070/user/updateExpert/${params._id}`, {
                        userId: params._id,
    ...
    return (
        <div>
            <div className="flex items-center justify-between flex-wrap gap-4">
                <h2 className="text-xl">Experts</h2>
                <div className="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                    ...
                    <div className="relative">
                        <input type="text" placeholder="Search Experts" className="form-input py-2 ltr:pr-11 rtl:pl-11 peer" value={search} onChange={(e) => setSearch(e.target.value)} />
                                ...
                                {filteredItems.map((contact: any) => {
                                    return (
                                        <tr key={contact._id}>
                                            ...
                                            <td className="whitespace-nowrap">{contact.field}</td>
                                ...
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="p-5">
                                        <form>
                                            ...
                                            <div className="mb-5">
                                                <label htmlFor="field">Feild</label>
                                                <input id="field" type="text" placeholder="Enter Feild" className="form-input" value={params.field} onChange={(e) => changeValue(e)} />
                                            </div>
                                            <div className="mb-5">
            ...
            <RegisterExpert isOpen={isRegisterUserModalOpen} onClose={closeRegisterUserModal} />
        </div>
    );
};
